...
def get_features_dataframe(
        ...
        use_graph_features: bool,
        backbone_sidechain_detail_level: int,
        # use_extra_backbone_sidechain_features: bool = True,
        use_extra_backbone_sidechain_features: bool = False,
        models_directory_path: str | None = 'simulations/models',
        predicted_features_detail_level: int = 1,
        gemini_features_detail_level: int = 1,
        # polybert_embedding_dim_count: int = 10
...
if __name__ == '__main__':
    ...
    train_models(
        ...
        target_names_to_extra_data_config_paths = {
            'Tg': 'configs_backup/XGBRegressor_data_Tg_447786.json',       # Pre data aug - maybe load from 1st backup.
        ...
        # },
        # target_names_to_extra_data_config_paths = {
        #     'Tg': 'configs_backup/LGBMRegressor_data_Tg_461983.json',      # Pre data aug - maybe load from 1st backup.
