...
def _get_poly_bert_embeddings(smiles_df: pd.DataFrame, polybert_embedding_dim_count: int):
    ...
    polybert: SentenceTransformer = load_backbone_into_sentence_transformer(
        ...
        finetuned_state_dict_path="models/20250912_233656_poly_6epochs_2thresh_v2.1_rankup/single_split/polymer_bert_rankup.pth",
        device="cuda"
    )
...
if __name__ == '__main__':
    ...
    #         # model_class=LGBMRegressor,
    #         # extra_data_config_path={
    #         #     'Tg': 'configs_backup/LGBMRegressor_data_Tg_461983.json',
    #         #     'FFV': 'configs_backup/LGBMRegressor_data_FFV_48.json',
    #         #     'Tc': 'configs_backup/LGBMRegressor_data_Tc_252.json',
    #         #     'Density': 'configs_backup/LGBMRegressor_data_Density_262.json',
    #         #     'Rg': 'configs_backup/LGBMRegressor_data_Rg_13684.json',
    #         # }[target_name],
    #         # model_class=CatBoostRegressor,
    #         # extra_data_config_path = {
    ...
    train_models(
        ...
        #     # 'Tg': 'configs/XGBRegressor_Tg_437882.json',                      # Very strong baseline
        ...
        #     # 'Tg': 'configs/XGBRegressor_Tg_418816_20250908032121.json',       # Tuned with extra features
        #     # 'FFV': 'configs/XGBRegressor_FFV_53_20250908081000.json',
        #     # 'Tc': 'configs/XGBRegressor_Tc_241_20250908102027.json',
        #     # 'Density': 'configs/XGBRegressor_Density_247_20250908124253.json',
        #     # 'Rg': 'configs/XGBRegressor_Rg_13015_20250908143648.json',
        #     'Tg': 'configs/XGBRegressor_Tg_418816_20250908032121.json',       # Tweaked
        #     'FFV': 'configs/XGBRegressor_FFV_53_manual.json',
        #     'Tc': 'configs/XGBRegressor_Tc_243_tweaked.json',
        #     'Density': 'configs/XGBRegressor_Density_293_manual_tweaked.json',
        #     'Rg': 'configs/XGBRegressor_Rg_12990_tweaked.json',
        # },
        # target_names_to_extra_data_config_paths = {
        #     'Tg': 'configs_backup/XGBRegressor_data_Tg_447786.json',       # Pre data aug
        #     'FFV': 'configs_backup/XGBRegressor_data_FFV_51.json',
        #     'Tc': 'configs_backup/XGBRegressor_data_Tc_248.json',
        #     'Density': 'configs_backup/XGBRegressor_data_Density_254.json',
        #     'Rg': 'configs_backup/XGBRegressor_data_Rg_14271.json',
        ...
        # model_class=LGBMRegressor,
        # target_names_to_model_config_paths={
        #     # 'Tg': 'configs/LGBMRegressor_Tg_429591.json',                   # Very strong baseline
        ...
        #     # 'Tg': 'configs/LGBMRegressor_Tg_423723_20250908044125.json',      # Tuned with extra features
        #     # 'FFV': 'configs/LGBMRegressor_FFV_50_20250908143717.json',
        #     # 'Tc': 'configs/LGBMRegressor_Tc_241_20250908164921.json',
        #     # 'Density': 'configs/LGBMRegressor_Density_244_20250908192206.json',
        #     # 'Rg': 'configs/LGBMRegressor_Rg_12831_20250908221549.json',
        #     'Tg': 'configs/LGBMRegressor_Tg_423723_20250908044125.json',      # Tweaked
        #     'FFV': 'configs/LGBMRegressor_FFV_47_manual.json',
        #     'Tc': 'configs/LGBMRegressor_Tc_241_20250908164921.json',
        #     'Density': 'configs/LGBMRegressor_Density_258_tweaked.json',
        #     'Rg': 'configs/LGBMRegressor_Rg_13172_tweaked.json',
        # },
        # target_names_to_extra_data_config_paths = {
        #     'Tg': 'configs_backup/LGBMRegressor_data_Tg_461983.json',      # Pre data aug
        #     'FFV': 'configs_backup/LGBMRegressor_data_FFV_48.json',
        #     'Tc': 'configs_backup/LGBMRegressor_data_Tc_252.json',
        #     'Density': 'configs_backup/LGBMRegressor_data_Density_262.json',
        #     'Rg': 'configs_backup/LGBMRegressor_data_Rg_13684.json',
        ...
        target_names_to_model_config_paths={
            ...
            # Tuned with extra features
            #   - wMAE = 0.05757 with 2000 seconds of compute per config ("best" quality, CPU only, baseline L1 models)
            #   - wMAE = 0.05901 with 200 seconds of compute per config ("good" quality, CPU only, baseline L1 models)
            # 'Tg': 'configs/TabularPredictor_Tg_431374_20250909060116.json',
            # 'FFV': 'configs/TabularPredictor_FFV_51_20250909100732.json',
            # 'Tc': 'configs/TabularPredictor_Tc_237_20250909144909.json',
            # 'Density': 'configs/TabularPredictor_Density_229_20250909194135.json',
            # 'Rg': 'configs/TabularPredictor_Rg_13036_20250910001950.json',
            # Swapped out polyBERT for pretrained version, forcefully enabled top-150 embedding dims.
        ...
        # model_class=RealMLP_TD_Regressor,
        # target_names_to_model_config_paths={
        #     # Baseline (wMAE = 0.06085)
        #     'Tg': 'configs/RealMLP_TD_Regressor_Tg_432262.json', # 42.56207
        #     'FFV': 'configs/RealMLP_TD_Regressor_FFV_52.json', # 0.00552
        #     'Tc': 'configs/RealMLP_TD_Regressor_Tc_258.json', # 0.02548
        #     'Density': 'configs/RealMLP_TD_Regressor_Density_270.json', # 0.02540
        #     'Rg': 'configs/RealMLP_TD_Regressor_Rg_13811.json', # 1.42535
        # },
        # target_names_to_extra_data_config_paths = {
        ...
        # model_class=TabM_D_Regressor,
        # target_names_to_model_config_paths={
        #     # # Baseline (wMAE = 0.05980)
        #     # 'Tg': 'configs/TabM_D_Regressor_Tg_433197.json', # 44.69784
        #     # 'FFV': 'configs/TabM_D_Regressor_FFV_50.json', # 0.00514
        #     # 'Tc': 'configs/TabM_D_Regressor_Tc_245.json', # 0.0241
        #     # 'Density': 'configs/TabM_D_Regressor_Density_241.json', # 0.02443
        #     # 'Rg': 'configs/TabM_D_Regressor_Rg_13313.json', # 1.33284
        #     # # "A team" retuning (wMAE = 0.05902)
        #     # 'Tg': 'configs/TabM_D_Regressor_Tg_425752_20250909022927.json', # 44.75631
        #     # 'FFV': 'configs/TabM_D_Regressor_FFV_49_20250909082431.json', # 0.0050
        #     # 'Tc': 'configs/TabM_D_Regressor_Tc_235_20250909092042.json', # 0.0240
        #     # 'Density': 'configs/TabM_D_Regressor_Density_236_20250909055241.json', # 0.0232
        #     # 'Rg': 'configs/TabM_D_Regressor_Rg_12837_20250909110148.json', # 1.29786
        #     # # "B team" retuning (wMAE = 0.05856)
        #     # 'Tg': 'configs/TabM_D_Regressor_Tg_431142_20250909093113.json', # 43.54401
        #     # 'FFV': 'configs/TabM_D_Regressor_FFV_50.json', # 0.0051
        #     # 'Tc': 'configs/TabM_D_Regressor_Tc_235_20250909125145.json', # 0.0236
        #     # 'Density': 'configs/TabM_D_Regressor_Density_241.json', # 0.02385
        #     # 'Rg': 'configs/TabM_D_Regressor_Rg_12895_20250909140347.json', # 1.31745
        #     # Hybrid (wMAE = 0.05816, 0.05820, 0.05821)
        #     'Tg': 'configs/TabM_D_Regressor_Tg_431142_20250909093113.json', # 43.54401
        #     'FFV': 'configs/TabM_D_Regressor_FFV_49_20250909082431.json', # 0.00501
        #     'Tc': 'configs/TabM_D_Regressor_Tc_235_20250909125145.json', # 0.0236
        #     'Density': 'configs/TabM_D_Regressor_Density_236_20250909055241.json', # 0.0232
        #     'Rg': 'configs/TabM_D_Regressor_Rg_12837_20250909110148.json', # 1.29786 (1.27883, 1.28884, 1.28244 reruns)
        # },
        # target_names_to_extra_data_config_paths = {
        #     'Tg': 'configs/TabM_D_Regressor_data_Tg_434216.json',
        #     'FFV': 'configs/TabM_D_Regressor_data_FFV_49.json',
