...
'''
ChemBERTa:
    Same TTA as train: 0.0720, 0.0728, 0.0737
    Enum only: 0.0729
    Enum only, 25x: 0.0726, 0.0738, 0.0731
ModernBERT: 
    Same TTA as train: 0.0663
    Enum only, 25x: 0.0661
polyBERT: 
    Same TTA as train:  0.0672
    Enum only, 25x: 0.0670
'''
