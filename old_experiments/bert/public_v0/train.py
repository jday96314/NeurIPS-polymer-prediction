...
model_path = 'Deepz/ChemBERTa-77M-MTR'
...
for warmup in [True, False]:
    for i in range(len(targets)):
        ...
        train_losses, val_losses = train_model(
            ...
            scaler=scaler,
            num_epochs=1, # TODO: Experimental
            learning_rate=2.8e-4, # TODO: Experimental
            device=device
        )
        ...
        if not warmup:
            torch.save(model.state_dict(), f'models/bert_v1_full_merge_chem_warmup_{target}.pth')
